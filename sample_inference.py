...
inferencer = Inferencer(cfg_path="/opt/data/private/TransCG/configs/inference.yaml")

rgb = np.array(Image.open('/opt/data/private/trans_cg/transcg/scene21/1/rgb1.png'), dtype = np.float32)
depth = np.array(Image.open('/opt/data/private/trans_cg/transcg/scene21/1/depth1.png'), dtype = np.float32)
depth_gt = np.array(Image.open('/opt/data/private/trans_cg/transcg/scene21/1/depth1-gt.png'), dtype = np.float32)
...
cam_intrinsics = np.load('/opt/data/private/trans_cg/transcg/camera_intrinsics/1-camIntrinsics-D435.npy')

res = np.clip(res, 0.3, 1.0).astype(np.float32)
